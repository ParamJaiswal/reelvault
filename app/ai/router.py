    ...
    def extract(self, unified_text: str, schema_type: str,
        ...
        if schema_type != "generic" and schema_type in SCHEMA_FIELDS:
            ...
            sys_p = (
                ...
                "NEVER PAD: if the source is short, output few facts. Every "
                "value must be actually stated in the source; do not reuse "
                "the same quote for multiple facts; an invented field is "
